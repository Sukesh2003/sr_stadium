...
<html>
<head>
  <title>SubbaReddy Stadium</title>
...
<body>
<header>
    <h1>SubbaReddy Stadium</h1>
    <p>Train like a Failure play like a pro</p>
  </header>
  <nav>
  <ul>
        <li><a href="home.html">Home</a></li>
        <li><a href="why.html">Join Us</a></li>
        <li><a href="about.html">Wha we do</a></li>
  ...
  <main>
    <section class="contact">
      ...
      <ul>
        <li style="font-size: 20px;"><strong>Address: </strong>CXF8+X8M, 3rd St, Lakeview Colony, Revenue Colony, Nellore, Andhra Pradesh 524004</li><br>
        <li style="font-size: 20px;"><strong>Phone: </strong>+91 8121737769</li><br>
        <li style="font-size: 20px;"><strong>Email: </strong>subbareddy1@gmail.com</li><br>
      </ul>
    </section>
    <section class="con">
